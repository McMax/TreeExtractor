...
//Due to low statistics, pp20 and pp31 have wider bins. This is applied only in ALICE style distributions.
	...
	histnClusters = new TH1I("histnClusters", "Number of all fitted clusters", 301, 0, 300);
	histnClustersPos = new TH1I("histnClustersPos", "Number of clusters all fitted (pos. charged)", 301, 0, 300);
	histnClustersNeg = new TH1I("histnClustersNeg", "Number of clusters all fitted (neg. charged)", 301, 0, 300);;

	histnClustersVtpc1 = new TH1I("histnClustersVtpc1", "Number of fitted clusters in VTPC1", 81, 0, 80);
	histnClustersVtpc1Pos = new TH1I("histnClustersVtpc1Pos", "Number of fitted clusters in VTPC1 (pos. charged)", 81, 0, 80);
	histnClustersVtpc1Neg = new TH1I("histnClustersVtpc1Neg", "Number of fitted clusters in VTPC1 (neg. charged)", 81, 0, 80);;

	histnClustersVtpc2 = new TH1I("histnClustersVtpc2", "Number of fitted clusters in VTPC2", 81, 0, 80);
	histnClustersVtpc2Pos = new TH1I("histnClustersVtpc2Pos", "Number of fitted clusters in VTPC2 (pos. charged)", 81, 0, 80);
	histnClustersVtpc2Neg = new TH1I("histnClustersVtpc2Neg", "Number of fitted clusters in VTPC2 (neg. charged)", 81, 0, 80);;

	histnClustersGtpc = new TH1I("histnClustersGtpc", "Number of fitted clusters in GTPC", 81, 0, 80);
	histnClustersGtpcPos = new TH1I("histnClustersGtpcPos", "Number of fitted clusters in GTPC (pos. charged)", 81, 0, 80);
	histnClustersGtpcNeg = new TH1I("histnClustersGtpcNeg", "Number of fitted clusters in GTPC (neg. charged)", 81, 0, 80);;

	histnClustersMtpc = new TH1I("histnClustersMtpc", "Number of fitted clusters in MTPC", 101, 0, 100);
	histnClustersMtpcPos = new TH1I("histnClustersMtpcPos", "Number of fitted clusters in MTPC (pos. charged)", 101, 0, 100);
	histnClustersMtpcNeg = new TH1I("histnClustersMtpcNeg", "Number of fitted clusters in MTPC (neg. charged)", 101, 0, 100);;
...
void Histos::write()
{
	...
	histnClusters->Write();
	histnClustersPos->Write();
	histnClustersNeg->Write();
...
void Histos::clear()
{
	...
	delete histnClusters;
	delete histnClustersPos;
	delete histnClustersNeg;
...
void Particles::analyze(Particle *particle, const int ener)
{
	...
	histos->histnClusters->Fill(particle->GetNClustersVtpc1() + particle->GetNClustersVtpc2() + particle->GetNClustersGtpc() + particle->GetNClustersMtpc());
	...
	if(particle->isPositive())
	{
		...
		histos->histnClustersPos->Fill(particle->GetNClustersVtpc1() + particle->GetNClustersVtpc2() + particle->GetNClustersGtpc() + particle->GetNClustersMtpc());
	...
	else
	{
		...
		histos->histnClustersNeg->Fill(particle->GetNClustersVtpc1() + particle->GetNClustersVtpc2() + particle->GetNClustersGtpc() + particle->GetNClustersMtpc());
